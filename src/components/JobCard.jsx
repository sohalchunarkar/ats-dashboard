    ...
    return (
        <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 hover:border-emerald-500/50 hover:shadow-lg hover:shadow-slate-200 dark:hover:shadow-slate-900/50 transition-all duration-200 flex flex-col gap-4 text-left">
            ...
            <div className="flex justify-between items-center">
                ...
                <span className="text-xs font-medium text-slate-500 transition-colors duration-200">
            ...
            <div>
                <h3 className="text-xl font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-200">
                    {job.title}
                </h3>
                <p className="text-sm text-slate-600 dark:text-slate-400 line-clamp-2 leading-relaxed transition-colors duration-200">
                    {job.description}
                </p>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-6 mt-2 pt-4 border-t border-slate-200 dark:border-slate-700/50 transition-colors duration-200">
                ...
                <div className="flex items-center gap-2 text-sm font-medium text-slate-700 dark:text-slate-300 ml-auto transition-colors duration-200">
                    <svg className="w-4 h-4 text-slate-400 dark:text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
